...

{
  ...
  boot.initrd.luks.devices."luks-5de58538-7302-4af9-bb02-fc97f371a581".device = "/dev/disk/by-uuid/5de58538-7302-4af9-bb02-fc97f371a581";
  networking.hostName = "HWY66"; # Define your hostname.
  ...
  # 7zip for compression/decompression needs
  p7zip
